    ...
    ESX.TriggerServerCallback('esx_organisation:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_organisation:removeVehicleFromGarage', 'vagos', vehicleProps)
...
AddEventHandler('esx_vagosjob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.org ~= nil and PlayerData.org.name == 'vagos' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.org ~= nil and PlayerData.org.name == 'vagos' then
      ...
      for k,v in pairs(Config.GangStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.org ~= nil and PlayerData.org.name == 'vagos' and PlayerData.org.gradeorg_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.org ~= nil and PlayerData.org.name == 'vagos' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableOrganisationOwnedVehicles then
            ...
            TriggerServerEvent('esx_organisation:putVehicleInGarage', 'vagos', vehicleProps)
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.org ~= nil and PlayerData.org.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'vagos_actions') and (GetGameTimer() - GUI.Time) > 150 then
