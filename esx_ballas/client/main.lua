...
function OpenCloakroomMenu()
	...
	if org == 'soldato' then
		table.insert(elements, {label = _U('ballas_wear'), value = 'recruit_wear'})
	elseif org == 'capo' then
		table.insert(elements, {label = _U('ballas_wear'), value = 'sergeant_wear'})
	elseif org == 'consigliere' then
		table.insert(elements, {label = _U('ballas_wear'), value = 'lieutenant_wear'})
	elseif org == 'boss' then
		table.insert(elements, {label = _U('ballas_wear'), value = 'boss_wear'})
	end
	...
	if Config.EnableOrganisationOwnedVehicles then
		...
		ESX.TriggerServerCallback('esx_organisation:getVehiclesInGarage', function(garageVehicles)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner',
			{
				...
				TriggerServerEvent('esx_organisation:removeVehicleFromGarage', 'ballas', vehicleProps)
			end, function(data, menu)
				menu.close()
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.org ~= nil and PlayerData.org.name == 'ballas' then
      ...
      for k,v in pairs(Config.ballasStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.org ~= nil and PlayerData.org.name == 'ballas' and PlayerData.org.gradeorg_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.org ~= nil and PlayerData.org.name == 'ballas' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
					...
					if Config.EnableOrganisationOwnedVehicles then
						...
						TriggerServerEvent('esx_organisation:putVehicleInGarage', 'ballas', vehicleProps)
					end
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.org ~= nil and PlayerData.org.name == 'ballas' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'ballas_actions') and (GetGameTimer() - GUI.Time) > 150 then
