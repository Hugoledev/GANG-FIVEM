Locales['fr'] = {
  ...
  ['owner'] = 'propriétaire : ',
  -- Weapons Menus
  ['get_weapon_menu'] = 'bloods - Prendre Arme',
  ['put_weapon_menu'] = 'bloods - Déposer Arme',
  ['buy_weapon_menu'] = 'bloods - Acheter Armes',
  ...
  ['quantity'] = 'Quantité',
  ['get_stock'] = 'bloods - Prendre Objet',
  ['put_stock'] = 'bloods - Déposer Objet',
  -- Notifications
  ['from'] = '~s~ à ~b~',
