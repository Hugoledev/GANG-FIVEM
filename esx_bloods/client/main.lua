...
function OpenCloakroomMenu()
	...
	if org == 'soldato' then
		table.insert(elements, {label = _U('bloods_wear'), value = 'recruit_wear'})
	elseif org == 'capo' then
		table.insert(elements, {label = _U('bloods_wear'), value = 'sergeant_wear'})
	...
	if Config.EnableOrganisationOwnedVehicles then
		...
		ESX.TriggerServerCallback('esx_organisation:getVehiclesInGarage', function(garageVehicles)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner',
			{
				...
				TriggerServerEvent('esx_organisation:removeVehicleFromGarage', 'bloods', vehicleProps)
			end, function(data, menu)
				menu.close()
  ...
  ESX.TriggerServerCallback('esx_bloods:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_bloods:buy', function(hasEnoughMoney)
  ...
  while true do
    ...
    if PlayerData.org ~= nil and PlayerData.org.name == 'bloods' then
      ...
      for k,v in pairs(Config.BloodsStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.org ~= nil and PlayerData.org.name == 'bloods' and PlayerData.org.gradeorg_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.org ~= nil and PlayerData.org.name == 'bloods' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
					...
					if Config.EnableOrganisationOwnedVehicles then
						...
						TriggerServerEvent('esx_organisation:putVehicleInGarage', 'bloods', vehicleProps)
					end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_organisation:openBossMenu', 'bloods', function(data, menu)
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.org ~= nil and PlayerData.org.name == 'bloods' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bloods_actions') and (GetGameTimer() - GUI.Time) > 150 then
