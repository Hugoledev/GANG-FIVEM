	...
	if Config.EnableOrganisationOwnedVehicles then
		...
		ESX.TriggerServerCallback('esx_organisation:getVehiclesInGarage', function(garageVehicles)
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner',
			{
				...
				TriggerServerEvent('esx_organisation:removeVehicleFromGarage', 'cartel', vehicleProps)
			end, function(data, menu)
				menu.close()
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.org ~= nil and PlayerData.org.name == 'cartel' then
      ...
      for k,v in pairs(Config.cartelStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.org ~= nil and PlayerData.org.name == 'cartel' and PlayerData.org.gradeorg_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.org ~= nil and PlayerData.org.name == 'cartel' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
					...
					if Config.EnableOrganisationOwnedVehicles then
						...
						TriggerServerEvent('esx_organisation:putVehicleInGarage', 'cartel', vehicleProps)
					end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_organisation:openBossMenu', 'cartel', function(data, menu)
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.org ~= nil and PlayerData.org.name == 'cartel' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'cartel_actions') and (GetGameTimer() - GUI.Time) > 150 then
