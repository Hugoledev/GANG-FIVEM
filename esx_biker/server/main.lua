...
AddEventHandler('esx_biker:drag', function(target)
  ...
  TriggerClientEvent('esx_biker:drag', target, _source)
end)
...
ESX.RegisterServerCallback('esx_biker:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_biker:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'organisation_biker', function(account)
